...
const file_kratos_admin_v1_admin_proto_rawDesc = "" +
	...
	"\bGetAdmin\x12 .kratos.admin.v1.GetAdminRequest\x1a\x16.kratos.admin.v1.Admin\"\x17\x82\xd3\xe4\x93\x02\x11\x12\x0f/v1/admins/{id}B8\n" +
	"\x13api.kratos.admin.v1P\x01Z\x1fgen_code/api/kratos/admin/v1;v1b\x06proto3"
